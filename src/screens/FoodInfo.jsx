  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        ...
        style={[
          tw`p-2 rounded-2xl flex-row justify-between items-center`,
          { color: COLORS.primary },
        ]}
      >
...
const Counter = ({ count, setCount }) => {
  return (
    <View
      style={[
        tw`flex-row justify-evenly items-center w-[90px] p-1 rounded-full`,
        { color: COLORS.primary },
      ]}
    >
      <TouchableOpacity
...
export const FoodInfo = ({ navigation, route }) => {
  const { name, image, description, price, rating, food, id } = route.params;
  const Food = food;
